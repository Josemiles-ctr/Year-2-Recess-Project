...
class PyTorchCnnModel(CnnModelGateway):
    ...
    def _load_model_weights(self) -> None:
        ...
        if os.path.isfile(self.model_path):
            ...
            logger.warning(f"Model weights not found at {self.model_path}. Using initialized model.")
    ...
    def _generate_grad_cam_heatmap(self, image_tensor: torch.Tensor, image_bytes: bytes, original_size: tuple[int, int]) -> str:
    ...
    def predict(self, scan: XRayScan) -> PredictionResult:
        ...
        try:
            ...
            grad_cam_path = self._generate_grad_cam_heatmap(image_tensor, scan.image_bytes, original_size)
